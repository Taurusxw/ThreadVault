...
def test_export_preview_preflight_discovery_schema_and_docs() -> None:
    ...
    for path in [
        Path("docs/progress/archive/legacy-v3/phases/phase-17-export-preview-governance-preflight/plan.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-17-export-preview-governance-preflight/design-notes.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-17-export-preview-governance-preflight/acceptance.md"),
    ]:
