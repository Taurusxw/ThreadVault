...
def test_client_session_discovery_schema_and_docs() -> None:
    ...
    for path in [
        Path("docs/progress/archive/legacy-v3/phases/phase-04-client-session-detail-workflow/plan.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-04-client-session-detail-workflow/design-notes.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-04-client-session-detail-workflow/acceptance.md"),
    ]:
