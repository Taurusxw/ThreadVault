...
def test_governance_audit_discovery_schema_and_docs() -> None:
    ...
    for path in [
        Path("docs/progress/archive/legacy-v3/phases/phase-08-local-audit-log-workflow/plan.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-08-local-audit-log-workflow/design-notes.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-08-local-audit-log-workflow/acceptance.md"),
    ]:
