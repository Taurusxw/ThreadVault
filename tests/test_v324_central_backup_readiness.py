...
def test_central_backup_readiness_discovery_schema_and_docs() -> None:
    ...
    for path in [
        Path("docs/progress/archive/legacy-v3/phases/phase-24-centralized-backup-restore-policy-readiness/plan.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-24-centralized-backup-restore-policy-readiness/design-notes.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-24-centralized-backup-restore-policy-readiness/acceptance.md"),
    ]:
