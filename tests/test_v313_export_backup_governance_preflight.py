...
def test_export_backup_preflight_discovery_schema_and_docs() -> None:
    ...
    for path in [
        Path("docs/v3/phases/phase-13-export-backup-governance-preflight/plan.md"),
        Path("docs/v3/phases/phase-13-export-backup-governance-preflight/design-notes.md"),
        Path("docs/v3/phases/phase-13-export-backup-governance-preflight/acceptance.md"),
    ]:
