...
def test_v3_completion_gap_audit_discovery_schema_and_docs() -> None:
    ...
    for path in [
        Path("docs/progress/archive/legacy-v3/phases/phase-21-v3-completion-gap-audit/plan.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-21-v3-completion-gap-audit/design-notes.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-21-v3-completion-gap-audit/gap-audit.md"),
        Path("docs/progress/archive/legacy-v3/phases/phase-21-v3-completion-gap-audit/acceptance.md"),
    ]:
